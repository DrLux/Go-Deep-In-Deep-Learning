...
![Formula per il calcolo dell' energia nelle reti di Hopfield](https://github.com/DrLux/Restricted-Boltzmann-Machine/blob/master/imgs/1.png?raw=true)
...
Cioè:
![Formula per il calcolo dell' energy gap](https://github.com/DrLux/Restricted-Boltzmann-Machine/blob/master/imgs/2.png?raw=true)

Quindi si calcola prima l’energia globale con questa formula, (ponendo Sj ad un valore attivo),  

![Alterazione dell' energia globale con un singolo neurone](https://github.com/DrLux/Restricted-Boltzmann-Machine/blob/master/imgs/3.png?raw=true)
...
![Rete di Esempio 1](https://github.com/DrLux/Restricted-Boltzmann-Machine/blob/master/imgs/4.png?raw=true)

Si inizializzano i neuroni ad uno stato random (1 o 0 i possibili valori assegnabili)

![Rete di Esempio 2](https://github.com/DrLux/Restricted-Boltzmann-Machine/blob/master/imgs/5.png?raw=true)

Si calcola l’energia totale secondo la formula data:

![Formula energia totale](https://github.com/DrLux/Restricted-Boltzmann-Machine/blob/master/imgs/6.png?raw=true)
...
A questo punto prendiamo un neurone a caso e ne calcoliamo l’ energy gap  ![Formula energy gap](https://github.com/DrLux/Restricted-Boltzmann-Machine/blob/master/imgs/6.png?raw=true) 
...
![Rete di Esempio 3](https://github.com/DrLux/Restricted-Boltzmann-Machine/blob/master/imgs/7.png?raw=true)
...
![Rete di Esempio 4](https://github.com/DrLux/Restricted-Boltzmann-Machine/blob/master/imgs/8.png?raw=true) 
 
Energia di questo neurone è:
(1*3) + (0*-1) = 3 -> Che è un numero positivo, e quindi lo lasciamo attivo

![Rete di Esempio 5](https://github.com/DrLux/Restricted-Boltzmann-Machine/blob/master/imgs/9.png?raw=true)
...
![Rete di Esempio 6](https://github.com/DrLux/Restricted-Boltzmann-Machine/blob/master/imgs/10.png?raw=true)
...
![Rete di Esempio 7](https://github.com/DrLux/Restricted-Boltzmann-Machine/blob/master/imgs/11.png?raw=true)
...
![Aggiornamento pesi 1](https://github.com/DrLux/Restricted-Boltzmann-Machine/blob/master/imgs/12.png?raw=true)
...
![aggiornamento pesi per più memorie](https://github.com/DrLux/Restricted-Boltzmann-Machine/blob/master/imgs/13.png?raw=true)
...
![Aggiornamento pesi 2](https://github.com/DrLux/Restricted-Boltzmann-Machine/blob/master/imgs/14.png?raw=true)
...
![Stati spuri](https://github.com/DrLux/Restricted-Boltzmann-Machine/blob/master/imgs/15.png?raw=true)
